...
//add totalamount
if(parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：",""))-$("#set_amount").val()>=0){
console.log(parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：",""))-$("#set_amount").val());
document.getElementById("need_to_pay").innerHTML="金額足夠可存入平台幣";
 
$('#confirm_submit').css('display', 'none');
document.getElementById("confirm_submit").disabled =true;
}else{
    document.getElementById("need_to_pay").innerHTML="需儲值"+(-parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())+"TWD");    
    document.getElementById("deposit_tokens").disabled =true;
    $('#deposit_tokens').css('display', 'none'); 

    //$("#TotalAmount").val()=(-parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())+"TWD");
    document.getElementById('TotalAmount').value =(-parseInt(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())) ;
    console.log($("#TotalAmount").val());
    //alert($("#TotalAmount").val());
    //document.getElementById("invest_text").innerHTML=$("#TotalAmount").val();
}
date();
MerchantTradeNo();
combine();
$('#set_amount').on('input', function() {
    ...
    if(parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：",""))-$("#set_amount").val()>=0){
        ...
        document.getElementById("confirm_submit").disabled =true;
        $('#confirm_submit').css('display', 'none');
        $('#deposit_tokens').css('display', '');
        document.getElementById("deposit_tokens").disabled =false;
        }else{
            document.getElementById("need_to_pay").innerHTML="需儲值"+(-parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())+"TWD");    
            document.getElementById("deposit_tokens").disabled =true;
            $('#deposit_tokens').css('display', 'none'); 
            document.getElementById("confirm_submit").disabled =false;
            $('#confirm_submit').css('display', '');
            //$("#TotalAmount").val()=(-parseFloat(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())+"TWD");
            document.getElementById('TotalAmount').value =(-parseInt(document.getElementById("have_token").innerHTML.replace("現有平台幣：","")-$("#set_amount").val())) ;
            console.log($("#TotalAmount").val());
            //alert($("#TotalAmount").val());
